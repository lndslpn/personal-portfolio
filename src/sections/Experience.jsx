...
export default function Experience() {
  ...
  return (
    <section id="experience" className="scroll-mt-30 bg-background min-h-[80vh] flex flex-col items-left justify-center text-center px-6">
      ...
      <div className="mt-5 grid grid-cols-1 gap-12 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 items-start justify-items-center">
        <div className="rounded bg-imagebrdr shadow-xl ring-1 ring-black/5 p-2 h-125 w-80 shadow-sm transition-transform duration-200 ease-out hover:-translate-y-1 hover:shadow-md">
          ...
          <div className="mt-2 rounded bg-background shadow-xl ring-1 ring-black/5 p-1 h-95 w-75">
            ...
            <p className="text-sm text-left font-inria text-white">Contributed to the Credit Technology team, developing and testing Java backend services for large-scale credit processing.</p>
            ...
            <ul className="list-disc text-left pl-5 text-sm font-inria text-white">
                  <li>Modernized backend logic by replacing static exclusion rules with dynamic runtime lookups across 1060+ branches,
                  improving maintainability across multiple credit services servicing 26M+ customers.</li>
                  <li>Implemented asynchronous event orchestration (Kafka Outbox) replacing direct Salesforce API calls, reducing
                  response time from ~9 sec to milliseconds.</li>
            </ul>
        ...
        <div className="rounded bg-imagebrdr shadow-xl ring-1 ring-black/5 p-2 h-140 w-80 shadow-sm transition-transform duration-200 ease-out hover:-translate-y-1 hover:shadow-md">
          ...
          <p className="text-sm font-bold text-left font-inria text-browntxt">AI Startup & Public Relations</p>
            <div className="mt-2 rounded bg-background shadow-xl ring-1 ring-black/5 p-1 h-110 w-75">
              <p className="text-md text-left font-inria text-browntxt">Overview</p>
              <p className="text-sm text-left font-inria text-white">Helped build wâsikan kisewâtisiwin, an Indigenous-focused LLM project that detects and mitigates bias and provides educated recommendations through Indigenous data.</p>
              <p className="mt-2 text-md text-left font-inria text-browntxt">Impact</p>
              <ul className="list-disc text-left pl-5 text-sm font-inria text-white">
                    <li>Built an end-to-end feedback pipeline processing 100+ daily records, enabling scalable data pipelines for LLM fine-tuning.</li>
                    <li>Led deployment of a containerized application on AWS (EC2, ECR, Nginx, Gunicorn) with CloudWatch monitoring,
                    reduced cloud costs by 35% through resource optimization and containerization.</li>
                    <li>Set up CI/CD with GitHub Actions, automating builds, deployments, and environment configuration.</li>
              </ul>
              <p className="mt-2 text-md text-left font-inria text-browntxt">Tools, Skills, & Concepts Used</p>
        ...
        <div className="rounded bg-imagebrdr shadow-xl ring-1 ring-black/5 p-2 h-130 w-80 shadow-sm transition-transform duration-200 ease-out hover:-translate-y-1 hover:shadow-md">
          ...
          <p className="text-sm font-bold text-left font-inria text-browntxt">Banking</p>
            <div className="mt-2 rounded bg-background shadow-xl ring-1 ring-black/5 p-1 h-100 w-75">
              ...
              <p className="mt-2 text-md text-left font-inria text-browntxt">Impact</p>
              <ul className="list-disc text-left pl-5 text-sm font-inria text-white">
                    <li>Automated a weekly business intake reporting workflow used by senior management by replacing 700+ lines of rigid VBA
                    with ~300 modular Python, reducing runtime by 50% and eliminating manual data cleanup.</li>
                    <li>Ensured reliability by writing a full test suite (100% coverage) and documenting system operation for non-technical staff.</li>
              </ul>
              <p className="mt-2 text-md text-left font-inria text-browntxt">Tools, Skills, & Concepts Used</p>
        ...
        <div className="rounded bg-imagebrdr shadow-xl ring-1 ring-black/5 p-2 h-127 w-80 shadow-sm transition-transform duration-200 ease-out hover:-translate-y-1 hover:shadow-md">
          <p className="text-sm text-right font-inria text-browntxt">May 2025 - Aug 2025</p>
          ...
          <div className="mt-2 rounded bg-background shadow-xl ring-1 ring-black/5 p-1 h-90 w-75">
              ...
              <p className="mt-2 text-md text-left font-inria text-browntxt">Impact</p>
              <ul className="list-disc text-left pl-5 text-sm font-inria text-white">
                    <li>Consolidated 50+ raw files into 1,000+ Cree English pairs; evaluated data-driven translation accuracy using automated
                    metrics (BLEU, COMET, etc.), comparing RAG vs. ICL architectures for Indigenous language translation.</li>
                    <li>Developed a full-stack evaluation interface for user model testing (10-100 users), integrating AWS EC2 deployment.</li>
              </ul>
              <p className="mt-2 text-md text-left font-inria text-browntxt">Tools, Skills, & Concepts Used</p>
      ...
      <div className="mt-5 grid grid-cols-1 gap-12 sm:grid-cols-1 lg:grid-cols-3 items-start justify-items-center">
      <div className="rounded bg-imagebrdr shadow-xl ring-1 ring-black/5 p-2 h-130 w-80 shadow-sm transition-transform duration-200 ease-out hover:-translate-y-1 hover:shadow-md">
      <p className="text-sm text-right font-inria text-browntxt">May 2024 - Aug 2024</p>
          ...
          <p className="text-sm font-bold text-left font-inria text-browntxt">Satellite Telecommunication</p>
            <div className="mt-2 rounded bg-background shadow-xl ring-1 ring-black/5 p-1 h-100 w-75">
              ...
              <p className="mt-2 text-md text-left font-inria text-browntxt">Impact</p>
              <ul className="list-disc text-left pl-5 text-sm font-inria text-white">
                    <li>Refactored a microservice (REST API) processing 1.4M+ data rows by removing ~75% deprecated logic,
                    introducing parallel data processing, and integrating 300K+ new satellite location rows.</li>
                    <li>Developed unit tests (0% to 93% coverage) and ensured consistent API behavior with a related Java microservice,
                    improving reliability and fault tolerance across services.</li>
              </ul>
              <p className="mt-2 text-md text-left font-inria text-browntxt">Tools, Skills, & Concepts Used</p>
        ...
        <div className="rounded bg-imagebrdr shadow-xl ring-1 ring-black/5 p-2 h-115 w-80 shadow-sm transition-transform duration-200 ease-out hover:-translate-y-1 hover:shadow-md">
