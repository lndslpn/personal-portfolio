...
export default function Education() {
    return (
      <section id="education" className="scroll-mt-20 bg-background min-h-[80vh] flex flex-col items-left justify-center text-center px-6">
        ...
        <div className="mt-10 grid grid-cols-1 gap-8 sm:grid-cols-1 lg:grid-cols-2 place-items-center">
          <div className="rounded bg-imagebrdr shadow-xl ring-1 ring-black/5 p-6 h-100 w-175" />
          <div className="rounded bg-imagebrdr shadow-xl ring-1 ring-black/5 p-6 h-100 w-175" />
        </div>
